...
flowchart LR
    ...
    Apply --> Live["live Meta CLI adapter"]
...
- `planner.py`: Converts desired source state into ordered create/update actions.
- `adapters.py`: Executes actions in mock mode or live Meta CLI mode.
